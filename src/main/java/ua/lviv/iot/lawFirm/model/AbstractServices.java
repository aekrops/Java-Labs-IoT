...
public abstract class AbstractServices {
    ...
    public String getHeaders() {
        return "drafting a claim" + "," + "signing a contract" + "," + "representationInCourt" + "," + "advice" + ","
                + "collecting evidence";
    }

    public String toCSV() {
        return getDraftingAClaim() + "," + getSigningAContract() + "," + getRepresentationInCourt() + "," + getAdvice()
                + "," + getCollectingEvidence();
    }
